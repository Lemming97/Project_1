...
var getNamedCocktail = function () {
  var userDrinkInput = drinkInputEL.value.trim();
  fetch(
    "https://www.thecocktaildb.com/api/json/v1/1/search.php?s=" + userDrinkInput
  )
...
document.getElementById("btnClear").onclick = function () {
  ...
  drinkResultsEL.textContent = "Previous drinks entered have been Cleared! Don't forget to wipe your browsing history too!";
};
